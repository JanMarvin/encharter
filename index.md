...
lives directly in `openxlsx2`, and `encharter` integrates with
`openxlsx2`’s own helper functions —
...
[`ec()`](https://janmarvin.github.io/encharter/reference/encharter.md)
(short for
[`encharter()`](https://janmarvin.github.io/encharter/reference/encharter.md))
creates an `R6` chart object. You then call methods on it to add series
and configure the chart, and finally hand it to
[`wb_add_encharter()`](https://janmarvin.github.io/openxlsx2/reference/wb_add_encharter.html).
...
![Fig 1: Our first \`encharter\` chart](inst/img/man_1.jpg)
...
which constructs the range strings from a workbook object that already
has data in it. This avoids hardcoding cell addresses and is less
error-prone when the data layout changes:
...
[`wb_data()`](https://janmarvin.github.io/openxlsx2/reference/wb_data.html)
pays off when building charts programmatically or when the source range
is determined at runtime, and feels more native to R.
...
[`wb_data()`](https://janmarvin.github.io/openxlsx2/reference/wb_data.html)
approach the name must correspond to a column in the data object.
Multi-level legends, where spreadsheet groups entries across two rows
...
features like drop-down lines require construction with
[`wb_data()`](https://janmarvin.github.io/openxlsx2/reference/wb_data.html)
...
six-digit hex value (`"4472C4"`) or a
[`wb_color()`](https://janmarvin.github.io/openxlsx2/reference/wb_color.html)
object from `openxlsx2`:
...
Chart titles also accept
[`fmt_txt()`](https://janmarvin.github.io/openxlsx2/reference/fmt_txt.html)
objects for mixed formatting within a single title — for example, a word
in bold followed by normal text:
...
![Fig 2: The initial chart with styling](inst/img/man_2.jpg)
...
![Fig 3: The line chart](inst/img/man_line.jpg)
...
![Fig 4: The bar chart](inst/img/man_bar_1.jpg)
...
![Fig 5: The stacked bar chart](inst/img/man_bar_2.jpg)
...
![Fig 6: The combo chart](inst/img/man_combo.jpg)
...
![Fig 7: The scatter chart](inst/img/man_scatter.jpg)
...
![Fig 8: The waterfall chart](inst/img/man_waterfall.jpg)
...
![Fig 9: The box and whisker chart](inst/img/man_boxwhisker.jpg)
