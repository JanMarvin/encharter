...
txt <- fmt_txt("Data: UK Driver Seatbelts Dataset (1969-1984)", italic = TRUE, color = wb_color("black"), size = 14)
...
e$add_series(data = wd, header = `12m Fatality Rate`, cat = date, secondary = TRUE, type = "line", line_color = wb_color("darkgreen"), line_width = 2)
