...
wb <- wb_add_chart(wb, sheet = "Data", dims = "A2:G12", chart_obj = my_wf)
wb <- wb_add_chart(wb, sheet = "Data", dims = "A13:G24", chart_obj = my_hist)
wb <- wb_add_chart(wb, sheet = "Data", dims = "H2:N12", chart_obj = my_funnel)
wb <- wb_add_chart(wb, sheet = "Data", dims = "H13:N24", chart_obj = my_bw)
wb <- wb_add_chart(wb, sheet = "Data", dims = "A25:G36", chart_obj = my_pl)
wb <- wb_add_chart(wb, sheet = "Data", dims = "H25:N36", chart_obj = my_sb)
wb <- wb_add_chart(wb, sheet = "Data", dims = "A37:G48", chart_obj = my_tm)
...
wb <- wb_add_chart(wb, sheet = "Data", dims = "H37:N48", chart_obj = my_rm)

wb$add_chartsheet("WorldMap")
wb <- wb_add_chart(wb, sheet = "WorldMap", chart_obj = my_rm)
